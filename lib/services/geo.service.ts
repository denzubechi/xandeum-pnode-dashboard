 ...
 */
export async function resolveIPToGeo(ip: string, timeoutMs = 5000): Promise<GeoLocation | null> {
  // Check cache first
 ...
 */
export async function resolveNodeGeo(address: string | undefined, timeoutMs = 3000): Promise<GeoLocation | null> {
